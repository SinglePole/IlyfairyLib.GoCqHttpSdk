...
namespace IlyfairyLib.GoCqHttpSdk.Api
{
    ...
    public static class MessageDistributorExtentsion
    {
        ...
        /// <param name="func">回调<br/>返回值代表是否继续向下传递</param>
        public static Session MapGroupMessage(this Session session, string regex, Func<GroupMessage, GroupCollection, Task> func)
        {
            session.MessageFuncs.Add((
              new(async v =>
              {
        ...
        /// <param name="regex">正则表达式</param>
        /// <param name="func">回调<br/>返回值代表是否继续向下传递</param>
        public static Session MapPrivateMessage(this Session session, string regex, Func<PrivateMessage, GroupCollection, Task> func)
        {
            session.MessageFuncs.Add((
              new(async v =>
              {
