...
public static class CQCodeEncoder
{
    ...
    {
        return $"[CQ:record,file={file.ToRawText()},magic={magic},cache={cache},proxy={proxy}]";
    }
    ...
    {
        return $"[CQ:video,file={file.ToRawText()},cover={cover.ToRawText()},c={c}]";
    }
    ...
    {
        return $"[CQ:at,qq={qq},name={name.ToRawText()}]";
    }
    ...
    {
        return $"[CQ:share,url={url.ToRawText()},title={title.ToRawText()},content={content.ToRawText()},image={image.ToRawText()}]";
    }
    ...
    {
        return $"[CQ:music,type=custom,url={url.ToRawText()},audio={audio.ToRawText()},title={title.ToRawText()},content={content.ToRawText()},image={image.ToRawText()}]";
    }
    ...
    {
        return $"[CQ:image,file={file.ToRawText()},type={type.ToRawText()},subType={subType},url={url.ToRawText()},cache={cache},id={id},c={c}]";
    }
    ...
    {
        return $"[CQ:reply,id={id},text={text.ToRawText()},qq={qq},time={time}]";
    }
    ...
    {
        return $"[CQ:xml,data={data.ToRawText()}]";
    }
    ...
    {
        return $"[CQ:json,data={data.ToJsonRawText()}]";
    }
    ...
    {
        return $"[CQ:cardimage,file={file.ToRawText()},minwidth={minwidth},minheight={minheight},maxwidth={maxwidth},maxheight={maxheight},source={source.ToRawText()},icon={icon.ToRawText()}]";
    }
}
